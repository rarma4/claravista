...
$assunto = ("contato pelo site CLARAVISTA");
$message = strip_tags(htmlspecialchars($_POST['inputMsg']));

$to = 'contato@claravista.com.br, comercial@grupocaa.com.br, comercial@claravista.com.br'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
